...
const Header: React.FC<HeaderProps> = ({ darkMode, toggleDarkMode }) => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full backdrop-blur-md bg-white/80 dark:bg-royal-900/80 border-b border-slate-200 dark:border-slate-700 transition-colors duration-300">
